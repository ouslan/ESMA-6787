...
\begin{enumerate}[(a)]
	...
	\item Create interaction plots of the factors for the fee schedule and scope of the work of the
	      ...
	      \begin{pythonbox}[Code for Interaction Graph]
		      \inputminted{python}{code/problem2a.py}
	      \end{pythonbox}
	...
	\item Create interaction plots of the factors fee schedule and type of supervisory control of the
	      ...
	      \begin{pythonbox}[Code for Interaction Graph]
		      \inputminted{python}{code/problem2b.py}
	      \end{pythonbox}
	...
	\item Obtain the analysis of variance table.
	      ...
	      \begin{pythonbox}[Code for Anova Table]
		      \inputminted{python}{code/problem2c.py}
	      \end{pythonbox}
	...
	\item Test for three-factor interactions: using $\alpha = 0.01$. State the alternatives, division rule, and conclusion.
	      ...
	      \textbf{Answer:} Given that C(Fee):C(Schedule):C(Supervisory) as a p-value of $0.767$ we don't have enough evidence to
	      ...
	      \begin{pythonbox}[Code for Anova Table]
		      \inputminted{python}{code/problem2d.py}
	      \end{pythonbox}
...
\begin{pythonbox}[Code for Anova Table]
	\inputminted{python}{code/problem2e.py}
\end{pythonbox}
...
\begin{enumerate}[(a)]
	\item Create interaction plots of the estimated treatment means. Does it appear that treatment
	      ...
	      \pagebreak
	      \begin{pythonbox}[Code for Anova Table]
		      \inputminted{python}{code/problem3a.py}
	      \end{pythonbox}
	...
	\item Obtain the analysis of variance table.
	      ...
	      \end{table}
	      \begin{pythonbox}[Code for Anova Table]
		      \inputminted{python}{code/problem3c.py}
	      \end{pythonbox}
...
\begin{enumerate}
	...
	\item Show that, $k \neq k'$
	      ...
	      \[
		      \begin{split}
			      Corr(Y_{ijk}, Y_{ijk'}) & = \frac{cov(Y_{ijk})}{\sqrt{var(Y_{ijk}) var(Y_{ijk'})}}                       \\
			                              & = \frac{\sigma_u^2}{\sqrt{(\sigma^2_u + \sigma^2_e)(\sigma^2_u + \sigma^2_e)}} \\
			                              & = \boxed{\frac{\sigma^2_u}{\sigma^2_u + \sigma^2_e}}                           \\
		      \end{split}
	      \]
\end{enumerate}
