...
\addcontentsline{toc}{section}{Problem 1: Definitions}
...
\addcontentsline{toc}{section}{Problem 2: Dough Experiment}
...
\begin{enumerate}[(a)]
	...
	\item Formulate a contrast to test the hypothesis that increase in rise height is a linear function of the increase in baking powder in the dough,
	      ...
	      \begin{table}[!ht]
		      \centering
		      \caption{ANOVA for the Effect of Baking Powder on Biscuit Rise Height and Linearity}
		      \begin{tabular}{lrrrrr}
			      \hline
			      \textbf{Source}          & \textbf{df} & \textbf{Sum of Squares} & \textbf{Mean Square} & \textbf{F-statistic} & \textbf{p-value}       \\
			      \hline
...
\addcontentsline{toc}{section}{Problem 3: Randomize group}
...
\addcontentsline{toc}{section}{Problem 4: Plant Growth}
...
\addcontentsline{toc}{section}{Problem 5: Accounting Firm}
